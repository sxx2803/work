function [ codeLength, newA, newN ] = golombAdaptiveLength( inVal, A, N, Nmax)
% golombAdaptive(inVal, A, N, Nmax) - Computes the length of the Golomb
...
%
% Output:
%   codeLength - the length of the Golomb code
