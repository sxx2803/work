...
public:
	...
	bool Save( const char* filename ) {
		...
		file.write(reinterpret_cast<char*>(image), Width() * Height() * sizeof(int) );
	...
	bool Load(const char* filename) {
		...
		// And read it all in.
		image = new int[ info.width * info.height ];
		...
		file.read((char*)image, info.width * info.height * sizeof(int));
